...
def process_rfi(cfg: Struct, raw_data: np.ndarray,
    ...
    if opt.mitigation_algorithm == "ST-EVD":
        ...
        rfi_likelihood = isce3.signal.rfi_process_evd.run_slow_time_evd(
            ...
            rfi_fig_merit_thresh=opt_evd.rfi_fig_merit_thresh,
            bright_target_check=opt_evd.bright_target_check,
            bt_condition_num_thresh_db=opt_evd.bt_condition_num_thresh_db,
            bt_pwr_spread_thresh_db=opt_evd.bt_pwr_spread_thresh_db,
            pwr_ref_percentile=opt_evd.pwr_ref_percentile,
            pwr_upper_percentile=opt_evd.pwr_upper_percentile,
            sig_ev_margin_upper_db=opt_evd.sig_ev_margin_upper_db,
            sig_ev_margin_lower_db=opt_evd.sig_ev_margin_lower_db,
            pcr_range=opt_evd.pcr_range,
