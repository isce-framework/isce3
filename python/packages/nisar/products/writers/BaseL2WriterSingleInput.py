...
class BaseL2WriterSingleInput(BaseWriterSingleInput):
    ...
    def populate_processing_information_l2_common(self):
        ...
        # If it’s unclear whether the dry tropospheric correction has been
        # applied, set `dryTroposphericGeolocationCorrectionApplied` to
        # '(NOT SPECIFIED)'. This should not occur in production, as RSLCs
        # generated by `focus.py` will always include the field
