...
class MainDiffMsBandEstimation(IonosphereEstimation):
    ...
    def __init__(self,
        ...
        error_channel = journal.error('ionosphere.MainDiffMsBandEstimation')
    ...
    def compute_disp_nondisp(self,
        ...
        """
        error_channel = journal.error('MainDiffMsBandEstimation.compute_disp_nondisp')
