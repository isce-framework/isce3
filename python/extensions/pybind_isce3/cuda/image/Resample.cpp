...
#include <isce3/cuda/image/Resample.h>
...
void addbindings_gpu_resamp(py::module & m)
{
    // Write _gpu_resample_to_coords as a private function. This will be used by a
    // wrapper called gpu_resample_to_coords that is written in Python.
    m.def("_gpu_resample_to_coords",
        &isce3::cuda::image::v2::gpuResampleToCoords,
        ...
        in_data_block: numpy.ndarray (complex64)
            Input SLC array basebanded in range direction.
