...
void addbinding(py::class_<Crossmul> & pyCrossmul)
{
    ...
    off by default.
        ...
        .def("set_rg_filter", [](Crossmul & self,
    ...
    Enables range band filtering and sets filtering parameters.
        ...
        .def("set_az_filter", [](Crossmul & self,
                    const double prf,
    ...
    Enables azimuth band filtering and sets filtering parameters.
        ...
        .def_property("common_az_bandwidth",
                py::overload_cast<>(&Crossmul::commonAzimuthBandwidth, py::const_),
                py::overload_cast<double>(&Crossmul::commonAzimuthBandwidth))
        .def_property("beta",
