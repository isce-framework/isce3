...
template<typename T>
void RasterBlockIter::getNext(array<T> &buffer, size_t length, size_t width, size_t band) {
    /*
     *  Gets the current block pointed to by the _xidx/_yidx indices and increments the iterator.
...
template<typename T>
void RasterBlockIter::getNext(array<T> &buffer, size_t length, size_t width) {
    /*
...
template<typename T>
void RasterBlockIter::getNext(array<array<T>> &buffer, size_t band) {
    /*
...
template<typename T>
void RasterBlockIter::getNext(array<array<T>> &buffer) {
    /*
     *  Gets the current block pointed to by the _xidx/_yidx indices and increments the iterator.
     *  Please refer to getNext(array<array<T>>&,size_t) above for implementation notes. Points to
...
template<typename T>
void RasterBlockIter::setNext(array<T> &buffer, size_t length, size_t width, size_t band) {
    /*
     *  Sets the current block pointed to by the _xidx/_yidx indices and increments the iterator.
     *  Needs to know the size of the buffer because it's a linearly-contiguous 1D STL container, so
     *  we can't infer the data layout. Points to a specific image band.
...
template<typename T>
void RasterBlockIter::setNext(array<T> &buffer, size_t length, size_t width) {
    /*
...
template<typename T>
void RasterBlockIter::setNext(array<array<T>> &buffer, size_t band) {
    /*
...
template<typename T>
void RasterBlockIter::setNext(array<array<T>> &buffer) {
    /*
     *  Sets the current block pointed to by the _xidx/_yidx indices and increments the iterator.
     *  Please refer to setNext(array<array<T>>&,size_t) above for implementation notes. Points to
     *  the default image band.
     */
    setNext(buffer, 1);
}
