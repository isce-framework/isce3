...
namespace isce { namespace dataio {
    struct RasterBlockIter {
        ...
        template<typename T> void getNext(std::array<T>&,size_t,size_t,size_t);
        template<typename T> void getNext(std::array<T>&,size_t,size_t);
        ...
        // (buffer, [band-index])
        template<typename T> void getNext(std::array<std::array<T>>&,size_t);
        template<typename T> void getNext(std::array<std::array<T>>&);
        ...
        template<typename T> void setNext(std::array<T>&,size_t,size_t,size_t);
        template<typename T> void setNext(std::array<T>&,size_t,size_t);
        ...
        // (buffer, [band-index])
        template<typename T> void setNext(std::array<std::array<T>>&,size_t);
        template<typename T> void setNext(std::array<std::array<T>>&);
    ...
    inline bool RasterBlockIter::operator==(const RasterBlockIter &rhs) {
        return (_raster == rhs._raster) && (_xidx == rhs._xidx) && (_yidx == rhs._yidx) &&
               (xskip == rhs.xskip) && (yskip == rhs.yskip);
    }
