...
TEST(geocodeTest, TestGeocodeSlc) {
    ...
    isce::core::LUT2d<double> nativeDoppler(imageGridDoppler.xStart(), 
                                            imageGridDoppler.yStart(),
                                            imageGridDoppler.xSpacing(),
    ...
    isce::product::GeoGridParameters geoGrid(geoGridStartX, geoGridStartY,
    ...
    isce::io::Raster inputSlc("x.slc", GA_ReadOnly);
      ...
      isce::io::Raster geocodedSlc("xslc.geo",
      ...
      isce::geocode::geocodeSlc(geocodedSlc, 
              inputSlc,
          demRaster,
          radarGrid,
          geoGrid,
      ...
      isce::io::Raster geocodedSlcY("yslc.geo",
        ...
        isce::geocode::geocodeSlc(geocodedSlcY, 
                inputSlcY,
            demRaster,
            radarGrid,
            geoGrid,
...
void createTestData() {
      ...
      isce::core::LUT2d<double> nativeDoppler = product.metadata().procInfo().dopplerCentroid('A');
      ...
      isce::io::Raster slcRasterX("x.slc",
                              width, length,
                              1, GDT_CFloat32, "ENVI");

      slcRasterX.setBlock(xslc, 0 , 0, width, length);

      isce::io::Raster slcRasterY("y.slc",
                                width, length,
                                1, GDT_CFloat32, "ENVI");
