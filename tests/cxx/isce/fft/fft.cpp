...
TEST(FFTTest, InvalidAxis)
{
    ...
    EXPECT_THROW( { isce::fft::fft1d(out.data(), in.data(), {n, batch}, 3); }, isce::except::OutOfRange );
}
...
TEST_P(PlanFFTTest, FFT1D)
{
    ...
    auto plan = isce::fft::planfft1d(out.data(), in.data(), n);
...
TEST_P(PlanFFTTest, FFTAxis0)
{
    ...
    auto plan = isce::fft::planfft1d(out.data(), in.data(), {n, batch}, 0);
...
TEST_P(PlanFFTTest, FFTAxis1)
{
    ...
    auto plan = isce::fft::planfft1d(out.data(), in.data(), {batch, n}, 1);
...
TEST_P(PlanFFTTest, FFT2D)
{
    ...
    auto plan = isce::fft::planfft2d(out.data(), in.data(), {n, n});
...
TEST_P(PlanFFTTest, InverseFFT1D)
{
    ...
    auto plan = isce::fft::planifft1d(out.data(), in.data(), n);
...
TEST_P(PlanFFTTest, InverseFFTAxis0)
{
    ...
    auto plan = isce::fft::planifft1d(out.data(), in.data(), {n, batch}, 0);
...
TEST_P(PlanFFTTest, InverseFFTAxis1)
{
    ...
    auto plan = isce::fft::planifft1d(out.data(), in.data(), {batch, n}, 1);
...
TEST_P(PlanFFTTest, InverseFFT2D)
{
    ...
    auto plan = isce::fft::planifft2d(out.data(), in.data(), {n, n});
...
TEST_P(FFTTest, FFT1D)
{
    ...
    isce::fft::fft1d(out.data(), in.data(), n);
...
TEST_P(FFTTest, FFTAxis0)
{
    ...
    isce::fft::fft1d(out.data(), in.data(), {n, batch}, 0);
...
TEST_P(FFTTest, FFTAxis1)
{
    ...
    isce::fft::fft1d(out.data(), in.data(), {batch, n}, 1);
...
TEST_P(FFTTest, FFT2D)
{
    ...
    isce::fft::fft2d(out.data(), in.data(), {n, n});
...
TEST_P(FFTTest, InverseFFT1D)
{
    ...
    isce::fft::ifft1d(out.data(), in.data(), n);
...
TEST_P(FFTTest, InverseFFTAxis0)
{
    ...
    isce::fft::ifft1d(out.data(), in.data(), {n, batch}, 0);
...
TEST_P(FFTTest, InverseFFTAxis1)
{
    ...
    isce::fft::ifft1d(out.data(), in.data(), {batch, n}, 1);
...
TEST_P(FFTTest, InverseFFT2D)
{
    ...
    isce::fft::ifft2d(out.data(), in.data(), {n, n});
