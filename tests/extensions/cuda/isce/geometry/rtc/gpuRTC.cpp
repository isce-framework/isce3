...
#include "isce/cuda/geometry/gpuRTC.h"

TEST(TestRTC, RunRTC) {
    // Open HDF5 file and load products
    isce::io::IH5File file("../../../../../lib/isce/data/envisat.h5");
    isce::product::Product product(file);

    // Open DEM raster
    isce::io::Raster dem("../../../../../lib/isce/data/srtm_cropped.tif");
    ...
    isce::cuda::geometry::facetRTC(product, dem, out_raster);
}
...
TEST(TestRTC, CheckResults) {
    ...
    isce::io::Raster refRaster("../../../../../lib/isce/data/rtc/rtc.vrt");
