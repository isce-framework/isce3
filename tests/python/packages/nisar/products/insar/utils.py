"""Tests for the mask-generation helpers in nisar.products.insar.utils.

The vectorized generate_insar_mask() and _subswath_numbers() must
reproduce the semantics of the original scalar per-pixel loop exactly:
