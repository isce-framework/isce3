...
import iscetest
from nisar.products.readers import GenericSingleSourceL2Product, open_product, RSLC
from nisar.products.readers.Raw import Raw


def test_generic_product():
    '''
    Test that the open_product function returns the correct kind of product, and 
    that the generation of product readers works more generally.
    '''
    ...
    _check_product("nisar_129_gcov_crop.h5", GenericSingleSourceL2Product, 'GCOV')
...
def _check_product(data_path, product_class, product_type_name) -> None:
    ...
    ----------
    data_path : str
        The path of the data to be checked relative to the `isce3test.data` directory.
