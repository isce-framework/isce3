...
- **NISAR_ANC_CORNER_REFLECTORS_001.csv**
  ...
  NISAR-format corner reflector CSV file with the 2025 updates requested by ISRO
  to support SSAR-specific validity codes and a new column distinguishing square
  and triangular corner reflectors.

- **NISAR_ANC_CORNER_REFLECTORS_006.csv**
...
- **data/focus/subswaths_dithered.npz**
